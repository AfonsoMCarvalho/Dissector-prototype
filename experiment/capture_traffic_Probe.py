...
def capture_traffic(capture_folder, sample_name):
    ...
    cmd = 'sudo tcpdump -i ' + NETWORK_INTERFACE + ' -C 2000 -w ' + capture_folder + sample_name + '_probe.pcap &'
...
def stop_capture(capture_folder, sample_name):
    cmd = 'tcpdump -i ' + NETWORK_INTERFACE + ' -C 2000 -w ' + capture_folder + sample_name + '_probe.pcap &'
    os.system('sudo pkill -15 -f ' + capture_folder + sample_name + '_probe.pcap')
    print('sudo pkill -15 -f ' + capture_folder + sample_name + '_probe.pcap')
